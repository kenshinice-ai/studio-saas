...
> 状态：**已执行（2026-08-20，v10.11.0，一步到位含 Xero 域）。**
> Lee 拍板「全部都执行 一步到位的模式 包括 xero 做好备份和handoff」。
> 执行记录与偏离（P3② 不建单消费者的 console-core.js；P2 用词法交集算 props
> 并以 48 张截图流水线验收）见 `docs/handoff/claude/2026-08-20-structure-refactor.md`。
>
