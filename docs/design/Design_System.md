...
See it rendered: [`docs/design/lab.html`](lab.html) — 16 theme-modes ×
...
harmony — by `docs/design/palette_gen.py`. 16 theme-modes × 61
pairs = 976 assertions run on every build, plus the semantic-role
and layering checks.

8 of the themes are offered to studios. One is the platform console,
...
| success / page | 4.5 | **4.60** | recital-plum light |
| warning / page | 4.5 | **4.60** | rehearsal-rose light |
| danger / page | 4.5 | **4.60** | studio-ink light |
...
2. `python3 docs/design/palette_gen.py` — 976 assertions.
