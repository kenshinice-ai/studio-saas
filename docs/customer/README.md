# PWE Studio v9.8.8 — Customer Delivery Index
...
This folder is the customer-facing source of truth for the v9.8.8 commercial conversation. Current release acceptance is recorded in `Release_Notes.md` and the full runtime ledger remains in `docs/HANDOFF_LATEST.md`.
...
The following remain explicitly outside the v9.8.8 product boundary:
