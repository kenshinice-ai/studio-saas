# PWE Studio v8.0.0 — Customer Delivery Index
...
This folder is the customer-facing source of truth for the v8.0.0 demonstration and pre-production conversation.

## Read first

1. [Release Notes and Acceptance Evidence](Release_Notes_v8.0.0.md)
...
The following are explicitly not represented as delivered in v8.0.0:
