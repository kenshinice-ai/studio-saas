# PWE Studio v8.2.2 — Current Handoff

## P0 public-registration consent visibility hotfix — release candidate (2026-08-01)

**Current repository truth:** branch `codex/v8.2.1-ics-p0`, version sources set
to **8.2.2**. This release retains the complete v8.2.1 ICS endpoint-kind repair
and adds the public registration fix below. Production remains on v8.2.1 until
the clean package and post-deployment browser gates in this handoff are updated.
...
Local browser, Quick Registration:
  checkbox click -> accessibility state [checked]
No registration was submitted during browser acceptance.
```
