...
> 适用版本：PWE Studio v8.5.3 · 界面：Studio Admin（`/<工作室网址标识>/studio-admin`）
> 与运营 CMS（`/<工作室网址标识>/cms`）
...
- 六个板块开关（Show/Hide）：主理人、课程、作品墙、FAQ、联系方式、学员专区。
  **没写内容的板块即使开着也不会显示空壳**；关掉的板块会同时从导航和页面上
  消失。v8.5.3 之前，「课程」和「作品墙」两个开关只隐藏了导航链接，板块本身
  仍留在页面上——工作室以为关掉了，访客往下滚仍然看得到。
