...
IMPORT_ORDER: tuple[str, ...] = (
    ...
    "class_schedule_exceptions.json",
    "class_bookings.json",
    ...
    # Were in SNAPSHOT_TABLES but never here, and the sync check below is a
    # strict equality — so every import run died on `SystemExit` before reading
    # a single row. Fixed in v10.0.0 together with the derived manifest guard.
    "cms_notifications.json",
    ...
    # ── v10.0.0 money layer, in foreign-key order ─────────────────────────
    "tenant_addons.json",
    "terms.json",
    "term_closures.json",
    ...
    # DEFERRED (migration 0033) so the pair resolves at commit rather than
    # forcing an order that cannot exist.
    "lesson_exceptions.json",
    "makeup_credits.json",
    "tax_codes.json",
    "billing_accounts.json",
    "billing_account_members.json",
    "document_number_sequences.json",
    "invoices.json",
    "invoice_lines.json",
    "invoice_events.json",
    "credit_notes.json",
    "credit_note_lines.json",
    "billing_schedules.json",
    ...
    "teacher_pay_periods.json",
    "teacher_pay_adjustments.json",
    "teaching_sessions.json",
    "xero_connections.json",
    "xero_account_mappings.json",
    "xero_sync_settings.json",
    "xero_object_links.json",
    "integration_sync_jobs.json",
    "notification_channels.json",
    "notification_routes.json",
    "notification_optouts.json",
    "calendar_subscriptions.json",
    "progress_report_settings.json",
