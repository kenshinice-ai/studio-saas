...
> 当前已验证交付物：v10.13.0 Edition。Edition 包内 `BUILD_INFO` 必须包含
...
- 已验证包为 `PWE-Studio-Edition-10.13.0.tar.gz`，SHA-256 为
  `7533c6a36b30aa146b70148af8c449254102d082b334311c05c5c19067a8ff0c`。
  每次发送或部署前必须在包所在目录执行
  `shasum -a 256 -c PWE-Studio-Edition-10.13.0.tar.gz.sha256`
