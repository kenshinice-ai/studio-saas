...
> 当前正式交付基线：v9.9.6。Edition 包内 `BUILD_INFO` 必须包含
...
- 当前已验证包为 `PWE-Studio-Edition-10.6.1.tar.gz`；发送前必须在包所在目录
  执行 `shasum -a 256 -c PWE-Studio-Edition-10.6.1.tar.gz.sha256`
