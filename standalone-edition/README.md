...
> **状态：v10.16.0 Edition 归档包已构建并验证（2026-08-24）。**
> `BUILD_INFO` 为 `version=10.16.0`、`mode=standalone`、
...
**正式归档：** `dist/PWE-Studio-Edition-10.16.0.tar.gz`
