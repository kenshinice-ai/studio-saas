...
> **状态：v10.14.0 发布候选（2026-08-24）；尚未形成已验证归档包。**
> 最后验证的 Edition 运行包仍为 v10.13.0；方案 A，定价已拍板。
> 基于 StudioSaaS v10.14.0 candidate。产品名：**PWE Studio Edition**。
...
## 6. v10.14.0 Edition 候选交付基线（尚未发布）
