...
| 版本 | `9.9.6` |
| 运行模式 | `standalone` |
| 官方包 | `PWE-Studio-Edition-9.9.6.tar.gz` |
...
```bash
shasum -a 256 -c PWE-Studio-Edition-9.9.6.tar.gz.sha256
tar xzf PWE-Studio-Edition-9.9.6.tar.gz
cd PWE-Studio-Edition-9.9.6
