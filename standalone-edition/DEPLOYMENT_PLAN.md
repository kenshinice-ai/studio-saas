# PWE Studio Edition v10.9.0 candidate · Standalone 完整部署方案（未发布）
...
| 版本 | `10.9.0 candidate` |
| 运行模式 | `standalone` |
| 官方包 | **尚未构建**；候选文件名 `PWE-Studio-Edition-10.9.0.tar.gz` |
...
```bash
shasum -a 256 -c PWE-Studio-Edition-10.9.0.tar.gz.sha256
tar xzf PWE-Studio-Edition-10.9.0.tar.gz
cd PWE-Studio-Edition-10.9.0
