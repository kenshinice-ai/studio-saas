# PWE Studio Edition v10.16.0 · Standalone 完整部署方案
...
| 版本 | `10.16.0` |
| 运行模式 | `standalone` |
| 官方包 | `PWE-Studio-Edition-10.16.0.tar.gz`（已构建并验证） |
...
```bash
shasum -a 256 -c PWE-Studio-Edition-10.16.0.tar.gz.sha256
tar xzf PWE-Studio-Edition-10.16.0.tar.gz
cd PWE-Studio-Edition-10.16.0
