...
在以下情况无需使用此 Skill：纯后端逻辑开发、仅涉及 API 或数据库设计、与界面无关的性能优化、基础设施或 DevOps 工作、非视觉类脚本或自动化任务。
...
| **Review existing UI** | "Review this page for UX issues"、"检查无障碍" | `references/quick-reference.md` checklist |
...
## Icon Library Preference (this project)
