...
(function () {
  ...
  const zh = Object.fromEntries([
    ...
    ['Accent colour', '强调色'],
    ['Hero Shape', '首屏形状'],
    ['Follow the visual style', '跟随视觉风格'],
    ['Following the style keeps the hero in step with the palette and the button roundness; pick a shape to override it.',
     '跟随风格时，首屏轮廓与配色、按钮圆度保持一致；选定一种形状即可覆盖。'],
