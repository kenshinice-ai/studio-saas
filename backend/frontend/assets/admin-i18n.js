...
(function () {
  ...
  const zh = Object.fromEntries([
    ...
    ['The first work is shown larger than the rest — put your strongest piece first. Up to 12; a work with neither a photo nor a video is not saved.',
     '第一件作品会比其余的展示得更大——把最强的一件放在最前。最多 12 件；既没有照片也没有视频的条目不会保存。'],
