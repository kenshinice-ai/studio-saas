...
const CMS_ROUTE_TABS = /* @__PURE__ */ new Set([
  "dashboard",
  "roster",
  "courses",
  "students",
...
function App() {
  ...
  const allLogs = useMemo(() => auditAsLogs.length ? [...db.logs, ...auditAsLogs].sort((a, b) => logTimestamp(b) - logTimestamp(a)) : db.logs, [db.logs, auditAsLogs]);
