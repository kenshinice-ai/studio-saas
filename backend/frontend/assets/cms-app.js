(() => {
  ...
  function StatusChip({ invoice }) {
    ...
    return /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { className: `text-[11px] font-bold px-1.5 py-0.5 rounded border whitespace-nowrap ${cls}` }, label), financial.creditState !== "none" && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold px-1.5 py-0.5 rounded border border-indigo-200 bg-indigo-50 text-indigo-700 whitespace-nowrap" }, CREDIT_STATE_LABEL[financial.creditState]));
  }
  ...
  function PayrollView({ api, showToast, range, onRange }) {
    ...
    const [sheetError, setSheetError] = useState2("");
    const [sheetRetry, setSheetRetry] = useState2(0);
    ...
    )), /* @__PURE__ */ React.createElement("tr", { className: "border-t border-gray-200 font-bold" }, /* @__PURE__ */ React.createElement("td", { className: "py-2", colSpan: 4 }, "本期应付"), /* @__PURE__ */ React.createElement("td", { className: "py-2 text-right tabular-nums" }, aud(sheet.summary.amount_cents))))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 items-center mt-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-gray-500" }, engagement.canPush ? "本版本先在这里算清应付金额；推送到 Xero 的通道还没接通，请把下面的清单交给会计，或在 Xero 里手工建应付账单。" : current?.engagement === "employee" ? "雇员工资不作为应付账单推送 —— 那会绕开薪资科目。导出清单交给财务走薪资流程。" : "未记录用工性质，无法决定这笔钱怎么进账。请先在老师资料里选择雇员或 ABN 承包。")))))));
  }
  ...
  function IntegrationsPanel({ api, showToast, confirm: confirm2, canManage }) {
    ...
    const backfillNow = () => {
      ...
      confirm2(
        `把这个工作室**已开具的全部**发票、贷记单与收款排进推送队列，送入 Xero 组织「${org || "（未能读到组织名）"}」。
...
确认这是正确的 Xero 组织后再继续。`,
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-bold" }, preview ? "Xero 预接入（Preview）" : "Xero 集成"), !preview && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold px-1.5 py-0.5 rounded border whitespace-nowrap bg-amber-50 text-amber-800 border-amber-200" }, "Beta"), /* @__PURE__ */ React.createElement("span", { className: `text-[11px] font-bold px-1.5 py-0.5 rounded border whitespace-nowrap
      ...
      ) : /* @__PURE__ */ React.createElement("p", { className: "text-[11px] text-gray-500" }, "需要 Owner / Manager 权限发起连接。"));
      ...
      "button",
      {
        type: "button",
        onClick: backfillNow,
        disabled: busy || !state.pushEnabled,
        className: "min-h-[44px] px-3 rounded-lg border border-gray-300 bg-white text-[11px] font-bold disabled:opacity-50"
      },
      "排队积压单据"
    ), /* @__PURE__ */ React.createElement(
      ...
      "逐张对账"
    ), !state.pushEnabled && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-gray-500 self-center" }, "推送开启之前，这几个动作不可用——上面的清单列出了还差什么。")), (queue?.jobs || []).filter((j) => j.status === "failed").slice(0, 8).map((j) => /* @__PURE__ */ React.createElement("div", { key: j.id, className: "rounded-lg border border-red-200 bg-red-50 p-2 mb-1.5 text-[11px] text-red-900" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold" }, j.local_kind, " · 第 ", j.attempts, " 次尝试失败"), /* @__PURE__ */ React.createElement("p", { className: "opacity-90 break-all" }, j.last_error), canManage && /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
  ...
  function BalBadge({ n }) {
    ...
    if (v === 0) return /* @__PURE__ */ React.createElement("span", { ...named, className: "inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold bg-red-100 text-red-700 whitespace-nowrap" }, /* @__PURE__ */ React.createElement(Icon, { name: "warning", className: "w-3.5 h-3.5" }), "0");
    if (v <= 2) return /* @__PURE__ */ React.createElement("span", { ...named, className: "inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold bg-orange-100 text-orange-700 whitespace-nowrap" }, /* @__PURE__ */ React.createElement(Icon, { name: "bolt", className: "w-3.5 h-3.5" }), v);
    if (v <= 4) return /* @__PURE__ */ React.createElement("span", { ...named, className: "inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold bg-amber-100 text-amber-700 whitespace-nowrap" }, /* @__PURE__ */ React.createElement(Icon, { name: "bolt", className: "w-3.5 h-3.5" }), v);
    return /* @__PURE__ */ React.createElement("span", { ...named, className: "px-2.5 py-1 rounded-lg text-xs font-bold bg-green-100 text-green-700 whitespace-nowrap" }, v);
  }
  ...
  function CmsNotificationCenter({
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "relative flex-shrink-0" }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-2.5" }, /* @__PURE__ */ React.createElement("span", { className: `mt-1.5 w-2 h-2 rounded-full flex-shrink-0 ${notification.read ? "bg-gray-200" : "bg-indigo-500"}`, "aria-hidden": "true" }), /* @__PURE__ */ React.createElement("span", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("span", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-sm truncate" }, notification.title), /* @__PURE__ */ React.createElement("span", { className: "text-[11px] text-gray-400 flex-shrink-0" }, formatCreatedAt(notification.createdAt))), /* @__PURE__ */ React.createElement("span", { className: "block mt-1 text-xs text-gray-600 leading-relaxed break-words" }, notification.summary)))
    )))));
  }
...
当前数据会先自动另存为 pre_restore 备份（可再恢复回来），然后被该备份覆盖。`,
  ...
  function LoginScreen({ onLogin, embedded = false }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: embedded ? "" : "min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 to-indigo-950 p-4" }, /* @__PURE__ */ React.createElement("div", { className: embedded ? "text-center" : "bg-white rounded-3xl p-8 w-full max-w-xs shadow-2xl text-center anim" }, !embedded && /* @__PURE__ */ React.createElement(TenantBrandLogo, { className: "w-36 max-h-20 object-contain mx-auto mb-3" }), !embedded && /* @__PURE__ */ React.createElement("p", { className: "tenant-slogan text-sm text-gray-500 italic mb-4" }, "Learn, grow, and feel confident."), !embedded && /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-400 mb-6" }, "请输入 Studio CMS 账号"), /* @__PURE__ */ React.createElement("form", { onSubmit: submit, className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "text-left" }, /* @__PURE__ */ React.createElement("label", { htmlFor: "cms-login-email", className: "block text-xs font-bold text-gray-500 mb-1" }, "管理员邮箱"), /* @__PURE__ */ React.createElement(
      "input",
      {
        id: "cms-login-email",
        type: "email",
      ...
      busy ? "验证中..." : "进入系统 →"
    )), /* @__PURE__ */ React.createElement("p", { className: "mt-6 pt-4 border-t border-gray-100 text-[11px] tracking-wide text-gray-400" }, "Powered by PWE")));
  }
  var ErrorBoundary = class extends React.Component {
    ...
    static getDerivedStateFromError(error) {
      const code = Math.random().toString(36).slice(2, 6).toUpperCase() + "-" + String(Date.now()).slice(-4);
      return { error, code };
    }
    ...
    render() {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "m-4 rounded-2xl border border-red-200 bg-red-50 p-5 max-w-2xl" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-red-800 text-sm mb-1" }, "这个页面出问题了"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-700 mb-1" }, "你刚才填的内容可能没有保存。已经保存过的数据不受影响。"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500 mb-4" }, "把这个编号告诉技术支持，可以在日志里找到这一次：", /* @__PURE__ */ React.createElement("span", { className: "ml-1 font-mono font-bold text-gray-700" }, this.state.code)), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, onLeave && /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
          onClick: () => {
  ...
  function RosterSection(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "anim space-y-4" }, /* @__PURE__ */ React.createElement("h2", { className: "md:hidden inline-flex items-center gap-1.5 text-xl font-bold text-gray-800" }, /* @__PURE__ */ React.createElement(Icon, { name: "calendar", className: "w-4 h-4" }), "课程安排"), scheduleLoadError && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 rounded-2xl border border-red-200 bg-red-50 p-3 text-sm text-red-700" }, /* @__PURE__ */ React.createElement("span", { className: "flex-1" }, scheduleLoadError), /* @__PURE__ */ React.createElement("button", { onClick: loadSchedules, className: "rounded-xl border border-red-200 bg-white px-3 py-2 text-xs font-bold min-h-[44px]" }, "重试")), /* @__PURE__ */ React.createElement("div", { className: "cms-roster-planner bg-white rounded-2xl shadow-sm border border-gray-100 p-4 space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-full" }, /* @__PURE__ */ React.createElement("label", { className: "cms-roster-date-label text-xs font-bold text-gray-500 mb-1 block" }, "课程日期"), /* @__PURE__ */ React.createElement("div", { className: "cms-roster-date-nav" }, /* @__PURE__ */ React.createElement(
      ...
      const cell = (d, { outside = false } = {}) => {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("p", { className: "text-[11px] opacity-70" }, monthOpen ? "" : WEEKDAYS2[d.getDay()], isToday ? "·今" : ""),
          /* @__PURE__ */ React.createElement("p", { className: "text-sm font-bold" }, d.getDate()),
          /* @__PURE__ */ React.createElement("p", { className: "text-[11px] font-bold opacity-80" }, n > 0 ? n : "—")
        );
      };
    ...
    })(), /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100" }, /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 border-b px-4 py-3 flex justify-between items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-sm text-gray-800" }, "今日名单", scheduledForDate.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-xs font-normal text-indigo-500 ml-1" }, `（课表 ${scheduledForDate.length} 班）`)), dayIds.length > 0 && /* @__PURE__ */ React.createElement("details", { className: "cms-day-actions-mobile" }, /* @__PURE__ */ React.createElement("summary", null, /* @__PURE__ */ React.createElement(Icon, { name: "ellipsis", className: "w-4 h-4" }), "当日操作"), /* @__PURE__ */ React.createElement("div", { className: "cms-roster-menu", onClick: closeMenu }, canExportData && /* @__PURE__ */ React.createElement("button", { onClick: () => openIcsPreview("roster"), disabled: icsBusy }, /* @__PURE__ */ React.createElement(Icon, { name: "calendar", className: "w-4 h-4" }), "导出当日 ICS"), /* @__PURE__ */ React.createElement("button", { onClick: copyRosterDaily }, /* @__PURE__ */ React.createElement(Icon, { name: "clipboard", className: "w-4 h-4" }), "复制日报"), dayIds.some((id) => {
      const s = db.students.find((x) => x.id === id);
      ...
      "button",
      {
        ...
        className: "inline-flex items-center gap-1.5 bg-white active:bg-indigo-50 disabled:opacity-40 text-indigo-700 border border-indigo-300 px-4 py-1.5 rounded-xl text-xs font-bold min-h-[44px]"
      },
      ...
      return /* @__PURE__ */ React.createElement("div", { key: sid, className: `cms-roster-row hover-row ${lowBal ? "is-low" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "cms-roster-info" }, /* @__PURE__ */ React.createElement(PhotoAvatar, { photo: s.photo, name: s.name, size: "sm" }), /* @__PURE__ */ React.createElement("div", { className: "flex-1 min-w-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 min-w-0 flex-wrap" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-gray-900 truncate" }, s.name), entry.oneToOne && /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold text-indigo-600 bg-indigo-50 border border-indigo-200 rounded-full px-2 py-0.5" }, "1 对 1"), rosterStatus !== "待上课" && /* @__PURE__ */ React.createElement("span", { className: `text-[11px] font-bold rounded-full px-2 py-0.5 border ${isDone ? "bg-green-50 border-green-200 text-green-700" : entry.status === "makeup" ? "bg-blue-50 border-blue-200 text-blue-700" : "bg-amber-50 border-amber-200 text-amber-700"}` }, rosterStatus)), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-400 truncate" }, [s.mobile || "未填写手机", slot, entry.note].filter(Boolean).join(" · "))), /* @__PURE__ */ React.createElement(BalBadge, { n: s.balance })), /* @__PURE__ */ React.createElement("div", { className: `cms-roster-actions ${lowBal ? "has-reminder" : ""}` }, TENANT_SLUG && entry.id && canWriteAttendance && /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "time",
  ...
  function WorksSection(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "anim space-y-5 max-w-6xl mx-auto" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-start justify-between gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { className: "md:hidden inline-flex items-center gap-2 text-xl font-bold text-gray-800" }, /* @__PURE__ */ React.createElement(Icon, { name: "image", className: "w-5 h-5" }), "作品管理"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-500 mt-1" }, "从这里按学员浏览作品；具体上传、编辑和公开授权仍在学员档案中完成。")), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => setTab("students"), className: "min-h-[44px] px-4 rounded-xl border border-indigo-200 bg-indigo-50 text-indigo-700 text-sm font-bold" }, "进入学员档案 →")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3" }, [["作品总数", portfolioEntries.length, "text-gray-900"], ["已公开", portfolioEntries.filter(({ item }) => item.public || item.visibility === "shared").length, "text-emerald-700"], ["待授权", portfolioEntries.filter(({ student }) => student.publicationConsent?.status !== "confirmed").length, "text-amber-700"], ["有作品学员", new Set(portfolioEntries.map(({ student }) => student.id)).size, "text-indigo-700"]].map(([label, value, color]) => /* @__PURE__ */ React.createElement("div", { key: label, className: "bg-white rounded-2xl border border-gray-100 shadow-sm p-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-400" }, label), /* @__PURE__ */ React.createElement("p", { className: `text-2xl font-bold mt-1 ${color}` }, value)))), /* @__PURE__ */ React.createElement(
      ...
      const badge = publicState === "shared" ? "已公开" : publicState === "blocked" ? "待家长授权" : "未公开";
      const badgeClass = publicState === "shared" ? "bg-emerald-50 border-emerald-200 text-emerald-700" : publicState === "blocked" ? "bg-amber-50 border-amber-200 text-amber-800" : "bg-gray-100 border-gray-200 text-gray-500";
      ...
      }, className: "block w-full text-left focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" }, /* @__PURE__ */ React.createElement("div", { className: "aspect-[4/3] bg-gray-100 overflow-hidden" }, item.filename ? /* @__PURE__ */ React.createElement("img", { src: portfolioThumbSrc(student.id, item), loading: "lazy", alt: `${student.name} 的作品`, className: "w-full h-full object-cover" }) : /* @__PURE__ */ React.createElement("div", { className: "w-full h-full inline-flex items-center justify-center text-gray-300" }, /* @__PURE__ */ React.createElement(Icon, { name: "image", className: "w-10 h-10" }))), /* @__PURE__ */ React.createElement("div", { className: "p-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2" }, /* @__PURE__ */ React.createElement("p", { className: "font-bold text-gray-900 truncate" }, item.title || item.note || "未命名作品"), /* @__PURE__ */ React.createElement("span", { className: `flex-shrink-0 text-[11px] font-bold px-2 py-0.5 rounded-full border ${badgeClass}`, title: publicState === "blocked" ? "这件作品已设为公开，但学员的家长授权还没确认，公开站上不会显示" : void 0 }, badge)), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500 mt-1 truncate" }, student.name, " · ", fmtDate(item.date)), item.note && item.title && /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-400 mt-1 line-clamp-2" }, item.note))), canWritePortfolio && /* @__PURE__ */ React.createElement("div", { className: "px-3 pb-3" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => {
        setTab("students", { recordId: student.id });
        setSelS(student);
        setEditP(false);
        setTimeout(() => {
  ...
  function StudentsSection(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "anim space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center gap-3 flex-wrap" }, /* @__PURE__ */ React.createElement("h2", { className: "md:hidden text-xl font-bold text-gray-800" }, `学员档案 (${sortedFiltered.length})`), /* @__PURE__ */ React.createElement("p", { className: "hidden md:block text-sm font-bold text-gray-500" }, `共 ${sortedFiltered.length} 人`), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, canManageOperations && /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        ...
        className: "flex-1 bg-indigo-50 active:bg-indigo-100 border border-indigo-200 text-indigo-800 py-3 rounded-xl text-sm font-bold min-h-[44px]"
      },
      "详情"
      ...
      "button",
      {
        ...
        disabled: busy,
        className: "flex-1 py-3 rounded-xl text-sm font-bold min-h-[44px] bg-white active:bg-indigo-50 text-indigo-700 border border-indigo-300 disabled:text-gray-400 disabled:border-gray-200 inline-flex items-center justify-center gap-1.5"
      },
      /* @__PURE__ */ React.createElement(Icon, { name: "calendar", className: "w-4 h-4" }),
  ...
  function LogsSection(props) {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "anim space-y-4" }, /* @__PURE__ */ React.createElement("h2", { className: "md:hidden inline-flex items-center gap-1.5 text-xl font-bold text-gray-800" }, /* @__PURE__ */ React.createElement(Icon, { name: "scroll", className: "w-4 h-4" }), "操作日志"), auditScope === "failed" && /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-red-200 bg-red-50 p-3 text-xs text-red-800" }, "服务端操作记录没能载入，下面只有课时流水部分。刷新页面可以重试。"), auditScope === "ledger-only" && /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-gray-200 bg-gray-50 p-3 text-xs text-gray-600" }, "你的角色只能看到课时流水部分；退款、导出等操作记录需要工作室负责人查看。"), auditScope === "truncated" && /* @__PURE__ */ React.createElement("div", { className: "rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs text-amber-800" }, "只载入了最近 200 条服务端操作记录。上方的日期筛选在这一批之内生效， 不会回到更早的历史。"), /* @__PURE__ */ React.createElement(
      FilterBar,
      {
      ...
      l
    ))), canManageOperations && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("span", { className: "ml-auto text-[11px] text-gray-400" }, "导出的是全部课时流水，不随上面的筛选变化"), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: exportLogsCSV,
        className: "inline-flex items-center gap-1.5 bg-white border border-gray-200 active:bg-gray-50 text-gray-600 px-3 py-2 rounded-xl font-bold text-xs min-h-[44px]"
      },
      /* @__PURE__ */ React.createElement(Icon, { name: "download", className: "w-4 h-4" }),
      "导出课时流水"
      ...
      /* @__PURE__ */ React.createElement("div", { className: "bg-white w-full sm:rounded-3xl shadow-2xl overflow-hidden anim border-t sm:border border-gray-200 flex flex-col cms-profile-sheet" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center p-4 bg-gray-50 border-b flex-shrink-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2.5 min-w-0" }, /* @__PURE__ */ React.createElement(PhotoAvatar, { photo: selS.photo, name: selS.name, size: "sm" }), /* @__PURE__ */ React.createElement("h3", { id: "student-profile-title", className: "text-lg font-bold text-gray-900 truncate" }, selS.name), /* @__PURE__ */ React.createElement(BalBadge, { n: selS.balance }), selS.archived && /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full shrink-0" }, "归档")), /* @__PURE__ */ React.createElement("button", { onClick: () => {
        ...
        return (
          ...
          /* @__PURE__ */ React.createElement("div", { className: "border border-gray-200 rounded-2xl overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "bg-gray-50 px-4 py-3 flex items-center justify-between" }, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold text-gray-900 flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Icon, { name: "image", className: "w-4 h-4" }), " ", workNoun, "集", /* @__PURE__ */ React.createElement("span", { className: "font-normal text-gray-500 text-xs ml-1" }, `(${items.length} 张)`)), /* @__PURE__ */ React.createElement(
            ...
            item.public && /* @__PURE__ */ React.createElement("span", { className: "absolute top-1 left-1 rounded-full bg-emerald-500 text-white text-[11px] font-bold px-2 py-0.5 shadow" }, "官网"),
  ...
  function App() {
    ...
    const [supportSession, setSupportSession] = useState10(null);
    const [sessionExpired, setSessionExpired] = useState10(false);
...
照片会从服务器删除，家长在学员专区也将不再看到它。如果只是不想公开展示，取消勾选「展示到官网作品墙」即可，照片仍会保留在私人记录里。`, async () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "flex h-screen bg-gray-50" }, toast && /* @__PURE__ */ React.createElement(Toast, { key: toast.key, msg: toast.msg, type: toast.type, action: toast.action, onDone: () => setToast(null) }), sessionExpired && /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "fixed inset-0 z-[97] bg-black/50 flex items-center justify-center p-4",
        role: "dialog",
        "aria-modal": "true",
        "aria-labelledby": "session-expired-title"
      },
      /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl max-w-md w-full p-5 shadow-xl" }, /* @__PURE__ */ React.createElement("p", { id: "session-expired-title", className: "font-bold text-gray-900 mb-1" }, "登录已过期"), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-600 mb-4" }, "刚才那一下没有保存。重新登录之后你会回到这一屏，已经填好的内容还在。"), /* @__PURE__ */ React.createElement(LoginScreen, { embedded: true, onLogin: () => {
        setSessionExpired(false);
        refreshSession();
      } }))
    ), supportSession && /* @__PURE__ */ React.createElement(
      "div",
      {
        role: "status",
        className: "fixed top-0 left-0 right-0 z-[60] flex flex-wrap items-center gap-3 px-4 py-2.5 bg-amber-700 text-white text-sm"
      },
      /* @__PURE__ */ React.createElement("strong", { className: "inline-flex items-center gap-1.5 font-bold tracking-wide" }, /* @__PURE__ */ React.createElement(Icon, { name: "warning", className: "w-4 h-4" }), "支持模式 · SUPPORT MODE"),
      /* @__PURE__ */ React.createElement("span", { className: "flex-1 min-w-0" }, "你正在 ", tenantDisplayName, " 的后台内操作，每一步都会写进审计记录。", supportSession.reason ? ` 原因：${supportSession.reason}` : ""),
      /* @__PURE__ */ React.createElement(
        "button",
        {
          type: "button",
          onClick: async () => {
            try {
              await fetch("/v1/admin/support-session/end", {
                method: "POST",
                credentials: "include",
                headers: { "Content-Type": "application/json" }
              });
    ...
    ), supportSession && /* @__PURE__ */ React.createElement("div", { className: "fixed top-0 left-0 right-0 h-[46px] pointer-events-none", "aria-hidden": "true" }), icsPreview && /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("div", { className: "p-3 border-t cms-chrome-edge space-y-1.5", style: { paddingBottom: "calc(env(safe-area-inset-bottom,0px) + 12px)" } }, TENANT_SLUG && /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-1.5 pb-1" }, /* @__PURE__ */ React.createElement(
        ...
        "使用手册"
      ), db.logsTruncated && /* @__PURE__ */ React.createElement("div", { className: "text-xs text-center rounded-lg p-1.5 border bg-amber-50 text-amber-700 border-amber-200" }, /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Icon, { name: "warning", className: "w-3.5 h-3.5" }), "只显示最近 ", db.logs.length, " 条")), canManageOperations && !TENANT_SLUG && /* @__PURE__ */ React.createElement("button", { onClick: exportDB, className: "inline-flex items-center gap-1.5 w-full cms-chrome-item border cms-chrome-edge p-2.5 rounded-xl text-xs font-bold min-h-[44px]" }, /* @__PURE__ */ React.createElement(Icon, { name: "download", className: "w-4 h-4" }), "备份导出"), /* @__PURE__ */ React.createElement("button", { onClick: load, disabled: busy, className: "inline-flex items-center gap-1.5 w-full cms-chrome-item border cms-chrome-edge p-2.5 rounded-xl text-xs font-bold min-h-[44px]" }, /* @__PURE__ */ React.createElement(Icon, { name: "refresh", className: "w-4 h-4" }), "刷新"), /* @__PURE__ */ React.createElement("button", { onClick: () => setSettingsSection("account"), className: `w-full cms-chrome-item border cms-chrome-edge p-2.5 rounded-xl text-xs font-bold min-h-[44px] ${tab === "settings" ? "is-active" : ""}` }, /* @__PURE__ */ React.createElement("span", { className: "inline-flex items-center gap-1.5" }, /* @__PURE__ */ React.createElement(Icon, { name: "cog", className: "w-4 h-4" }), "系统设置")), /* @__PURE__ */ React.createElement(
        "button",
        {
      ...
      /* @__PURE__ */ React.createElement("header", { className: "hidden md:flex sticky top-0 z-30 -mx-6 px-6 h-16 items-center gap-4 bg-gray-50/95 backdrop-blur border-b border-gray-200" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 min-w-[210px]" }, tab !== "dashboard" && /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("kbd", { className: "float-right hidden lg:inline-flex rounded-md bg-gray-100 px-1.5 py-0.5 text-[11px] font-mono text-gray-500" }, "⌘K")
      ...
      ), tab === "finance" && /* @__PURE__ */ React.createElement(FinancePanel, { api: v1Api, showToast }), tab === "topup" && /* @__PURE__ */ React.createElement(TopupSection, { ...{ archivePackage, busy, canManageOperations, canRefund, canRegisterSettlementPayment, canSyncRefund, canUseSettlementBilling, db, handleRefund, handleTopUp, pkgCredits, pkgEditId, pkgName, pkgPrice, refundSourceError, refundSources, refundSourcesBusy, resetPackageEditor, rfAdjustDocuments, rfAmountTouched, rfAmt, rfCr, rfReason, rfSourceId, savePackage, setPkgCredits, setPkgEditId, setPkgName, setPkgPrice, setRfAdjustDocuments, setRfAmountTouched, setRfAmt, setRfCr, setRfReason, setRfSourceId, setSettleMode, setSettlementPayer, setSettlementPayerError, setSettlementPayerState, setTuCr, setTuCreateInvoice, setTuFee, setTuPay, setTuPaymentReceived, setTuPkg, setTuStu, settleMode, settlementAccounts, settlementPayerError, settlementPayerIntentRef, settlementPayerState, settlementResolvedAccountRef, settlementTaxCodes, sortedAZ, tuCr, tuCreateInvoice, tuFee, tuPay, tuPaymentReceived, tuPkg, tuStu } }), tab === "logs" && /* @__PURE__ */ React.createElement(LogsSection, { ...{ auditScope, canManageOperations, displayNote, exportLogsCSV, filteredLogs, lAct, lDateFrom, lDateTo, lPage, lSrch, lStu, logActions, logPageCount, pagedLogs, setLAct, setLDateFrom, setLDateTo, setLPage, setLSrch, setLStu, sortedAZ } }), tab === "stats" && /* @__PURE__ */ React.createElement(StatsSection, { ...{ analytics, bizReport, exportBizCSV, exportRevenueCSV, payBreakdown, sFrom, sPeriod, sStu, sStu2, sTo, sYear, setSFrom, setSPeriod, setSStu, setSStu2, setSTo, setSYear, sortedAZ, statsData, studentStats } })),
...
此操作不影响任何统计数据。`, async () => {
      ...
      /* @__PURE__ */ React.createElement("footer", { className: "mt-8 pb-6 text-center text-[11px] tracking-wide text-gray-400" }, "© 2026 ", tenantDisplayName, " · Powered by PWE")
      ...
      [{ k: "courses", s: "课程" }, { k: "works", s: "作品" }, { k: "logs", s: "日志" }, { k: "stats", s: "统计" }, { k: "pending", s: "待处理", badge: pendingCount }, { k: "new_student", s: "新建" }, { k: "settings", s: "设置" }].filter((item) => allowedTabs.includes(item.k)).map(({ k, s, badge }) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key: k,
          onClick: () => {
        ...
        /* @__PURE__ */ React.createElement(Icon, { name: NAV_ICON[k], className: "w-[22px] h-[22px]" }),
        /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold leading-none tracking-tight" }, s),
        badge > 0 && /* @__PURE__ */ React.createElement("span", { className: "absolute top-1 right-2 bg-amber-400 text-white text-[11px] font-bold px-1 rounded-full min-w-[15px] text-center leading-4" }, badge)
      ))
    ), /* @__PURE__ */ React.createElement(
      "nav",
      {
      ...
      [{ k: "dashboard", s: "工作台" }, { k: "roster", s: "课表" }, { k: "students", s: "档案" }, { k: "topup", s: "充值" }].filter((item) => allowedTabs.includes(item.k)).map(({ k, s }) => /* @__PURE__ */ React.createElement(
        "button",
        {
          key: k,
          onClick: () => {
        ...
        /* @__PURE__ */ React.createElement(Icon, { name: NAV_ICON[k], className: "w-[22px] h-[22px]" }),
        /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold leading-none tracking-tight" }, s),
        k === "dashboard" && analytics.lowBalance.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "absolute top-1.5 right-[18%] bg-red-500 text-white text-[11px] font-bold px-1 rounded-full min-w-[15px] text-center leading-4" }, analytics.lowBalance.length)
      )),
      /* @__PURE__ */ React.createElement(
        "button",
        {
        ...
        /* @__PURE__ */ React.createElement("span", { className: "text-[11px] font-bold leading-none tracking-tight" }, "更多"),
        pendingCount > 0 && !moreOpen && /* @__PURE__ */ React.createElement("span", { className: "absolute top-1.5 right-[18%] bg-amber-400 text-white text-[11px] font-bold px-1 rounded-full min-w-[15px] text-center leading-4" }, pendingCount)
      )
    ));
  }
