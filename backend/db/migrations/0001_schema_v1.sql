...
VALUES
    ('starter', 'Starter', 49, 50, 1, 2048, '{"public_registration": true, "portfolio": true}'::jsonb),
    ('studio', 'Studio', 99, 250, 5, 10240, '{"public_registration": true, "portfolio": true, "email_templates": true, "data_export": true}'::jsonb),
    ('growth', 'Growth', 189, 500, 20, 51200, '{"public_registration": true, "portfolio": true, "email_templates": true, "data_export": true, "priority_support": true}'::jsonb)
