...
Current production release: **v8.2.3** operations-log completeness, roster default class time and versioned asset URLs, retaining the v8.2.2 registration consent repair (deployed 2026-08-01)
