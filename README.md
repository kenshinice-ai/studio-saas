...
Production remain separate rows. **v10.5.0 is committed, packaged and deployed** as of 15 August 2026 —
each row below was verified after the fact, not inferred from the version label.
...
| Package | **v10.5.0 built and verified** | SaaS `dist/PWE-StudioSaaS-aws-10.5.0.tar.gz` SHA-256 `61227487ea49baadda07c8e66327d7fb523543a2dbe0c78bf150b8b00c4bbc5f`; Edition `dist/PWE-Studio-Edition-10.5.0.tar.gz` SHA-256 `f4447a50b618ddae2976ca439f890cbc1995c8e2aa308fe8f90c806bd0fbca2f`. Both passed `verify_release_bundles.sh` — checksum, BUILD_INFO, entrypoint and exclusion checks. |
